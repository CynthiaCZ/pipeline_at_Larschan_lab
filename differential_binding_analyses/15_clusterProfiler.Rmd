...
```{r} 
in_dir <- "/Users/cynthiacz/Desktop/CnR_2023/DiffBind/annotated_peaks"
out_dir <- "/Users/cynthiacz/Desktop/CnR_2023/DiffBind/enrichGO/"
plot_dir <- "/Users/cynthiacz/Desktop/CnR_2023/DiffBind/enrichGO_plots/"
```

```{r}
csv_file <- file.path(in_dir, "1_files.csv")
con <- file(csv_file, "r")
...
while (length(line <- readLines(con, n = 1)) > 0) {
    ...
    ego <- enrichGO(gene = annotated_peaks$ENTREZID,
                OrgDb = org.Dm.eg.db,
                ont = "ALL")
    outfile_name <- paste(out_dir, base_name, ".GO.tsv", sep = "")
    write.table(ego, file = outfile_name, sep = "\t", row.names = FALSE)
}
```
